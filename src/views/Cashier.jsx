...
function Cashier() {
  ...
  useEffect(() => {
    const onKeyDown = (event) => {
      ...
      if (event.key === 'Enter' && selected.paymentTone === 'cash') markCashPaid()
