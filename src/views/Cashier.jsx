...
function Cashier() {
  const { orders, outlet, accept, reject, markCashPaid: settleCash } = useStore()
  ...
  return (
    <div className="app-shell">
      <aside className="sidebar">
        <div className="brand-lockup"><div className="brand-mark">K</div><div><strong>{outletName}</strong><span>CONTROL ROOM</span></div></div>
        <div className="outlet-switcher"><span className="live-dot" /> <span><b>{outletName}</b><small>Shift pagi · Aktif</small></span><Icon name="chevron" /></div>
